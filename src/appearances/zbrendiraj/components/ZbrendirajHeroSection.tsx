  ...
  return (
    <section className="relative overflow-hidden bg-black px-4 pb-24 pt-28 sm:px-6 sm:pb-28 sm:pt-32 lg:pb-32">
      <div className="mx-auto max-w-7xl">
        <div className="relative flex min-h-[480px] flex-col justify-between rounded-[var(--radius-card)] border border-accent/30 bg-[#0A0A0A] p-8 sm:min-h-[560px] sm:p-10 lg:min-h-[600px] lg:p-14">

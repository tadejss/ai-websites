...
/**
 * Renders a stored stock image. Prefer AVIF with WebP fallback via <picture>
 * when both URLs are present; otherwise Next.js Image (local /clients or remote Blob).
 */

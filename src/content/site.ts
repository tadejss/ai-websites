...
export const siteConfig: SiteConfig = {
  ...
  metadata: {
    title: "Ime Podjetja | Lokalno podjetje",
    description:
      "Profesionalne storitve v vaši bližini. Zanesljivost, kakovost in osebni pristop za vsako stranko.",
  },
  nav: {
    links: [
  ...
  hero: {
    badge: "Odprto danes do 17:00",
    title: "Kakovostna storitev v",
    titleHighlight: "vaši bližini",
    description:
      "Lokalno podjetje z dolgoletnimi izkušnjami. Osebni pristop, poštene cene in storitve, ki jim lahko zaupate.",
  ...
  services: {
    ...
    description:
      "Ponujamo širok nabor storitev, prilagojenih potrebam naših strank. Vsak projekt obravnavamo s skrbnostjo in pozornostjo do detajlov.",
    items: [
      {
        title: "Osnovne storitve",
        description:
          "Celovite rešitve za vsakodnevne potrebe z jasno komunikacijo in dogovorjenimi roki.",
        icon: "service-1",
      },
      {
        title: "Specializirane storitve",
        description:
          "Strokovno znanje in oprema za zahtevnejše naloge in posebne zahteve strank.",
        icon: "service-2",
      },
      {
        title: "Svetovanje",
        description:
          "Personalizirani nasveti in načrti, prilagojeni vašim ciljem in proračunu.",
        icon: "service-3",
      },
      {
        title: "Vzdrževanje",
        description:
          "Redno spremljanje in preventivno vzdrževanje za dolgoročno zanesljivost.",
        icon: "service-4",
      },
      {
        title: "Podpora strankam",
        description:
          "Dostopna pomoč in odgovori na vprašanja skozi celoten proces sodelovanja.",
        icon: "service-5",
      },
      {
        title: "Hitra pomoč",
        description:
          "Prioritetna obravnava nujnih primerov z jasno oceno časa in stroškov.",
        icon: "service-6",
      },
    ],
  },
  ...
  contact: {
    ...
    items: [
      {
        label: "Naslov",
        value: "Ulica 123, 1000 Mesto",
        icon: "location",
      },
      {
        label: "Telefon",
        value: "+386 1 000 00 00",
        href: "tel:+38610000000",
        icon: "phone",
      },
      {
        label: "E-pošta",
        value: "info@podjetje.si",
        href: "mailto:info@podjetje.si",
        icon: "email",
      },
      {
        label: "Delovni čas",
        value: "Pon–Pet: 8:00–17:00 · Sob: 9:00–13:00",
        icon: "clock",
      },
    ],
    form: {
